...
from custom_components.xiaomi_cloud_map_extractor.vacuum_platforms.vacuum_ijai_ import (
    IjaiCloudVacuum,
)
...
def parse_map_file(map_config, map_filename, api, suffix=""):
    ...
    try:
        ...
        elif api == CONF_AVAILABLE_API_IJAI:
            vacuum = IjaiCloudVacuum(vacuum_config)
        else:
...
if __name__ == "__main__":
    ...
    args_parser_parse.add_argument(
        "--api",
        type=str,
        choices=["xiaomi", "viomi", "roidmi", "dreame", "ijai"],
        required=True,
        help="used api",
    )
